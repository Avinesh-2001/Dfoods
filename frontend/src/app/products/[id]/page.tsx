      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
          ...
          <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24 self-start">
            {/* Product Title */}
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-black mb-2">{product.name}</h1>
                ...
                <div className="flex items-center gap-2 mb-3">
                  <div className="flex items-center">
                    {[...Array(5)].map((_, i) => {
                      ...
                      return (
                        <svg key={i} className={`w-3.5 h-3.5 ${i < Math.floor(avgRating) ? 'text-yellow-400 fill-yellow-400' : 'text-orange-200 fill-orange-200'}`} viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="w-3.5 h-3.5 border-2 border-green-600 rounded flex items-center justify-center">
                  <div className="w-1 h-1 bg-green-600 rounded-full"></div>
                </div>
                <span className="text-[11px] text-black">This is a Vegetarian product</span>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-baseline gap-2 mb-1">
                <div className="text-xl font-bold text-black">₹{currentPrice}</div>
                {product.originalPrice && product.originalPrice > currentPrice && (
                  <span className="text-xs text-gray-500 line-through">₹{product.originalPrice}</span>
                )}
              </div>
              {product.originalPrice && product.originalPrice > currentPrice && (
                <div className="text-[10px] text-green-700 font-semibold mb-2">
            ...
            <div className="pt-3 border-t border-gray-200 relative share-popup-container">
              ...
              {showSharePopup && (
                <div className="absolute top-full left-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10 min-w-[250px]">
        ...
        <div className="mb-8 bg-white">
          ...
          <div className="border-b border-gray-200 py-4">
            <h3 className="text-base font-bold text-[#1a472a] mb-4 text-center">FAQ</h3>
          ...
          {(relatedProducts.length > 0 || allProducts.length > 0) && (
            <div className="my-8">
              <div className="mb-6">
                <h2 className="text-lg font-bold text-black mb-2 text-center">Recommended Products</h2>
          ...
          <div className="py-4">
            <h3 className="text-base font-bold text-[#1a472a] mb-4 text-center">Customer Reviews</h3>
            ...
            <div className="px-4 pb-6">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                    {/* Left: Overall Rating */}
                    <div className="flex flex-col items-center md:items-start pb-4 border-b md:border-b-0 md:border-r border-gray-300 pr-4">
                      ...
                      <div className="flex items-center gap-1 mb-2">
                        {[...Array(5)].map((_, i) => {
                          const avgRating = approvedReviews.length > 0 
                            ...
                            : 0;
                          return (
                            <svg key={i} className={`w-4 h-4 ${i < Math.floor(avgRating) ? 'text-yellow-400 fill-yellow-400' : i < avgRating ? 'text-yellow-300 fill-yellow-300' : 'text-orange-200 fill-orange-200'}`} viewBox="0 0 24 24">
                              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                            </svg>
                          );
                        })}
                    ...
                    <div className="space-y-2 pb-4 border-b md:border-b-0 md:border-r border-gray-300 pr-4">
                      {[5, 4, 3, 2, 1].map((stars) => {
                        ...
                        <div className="flex gap-1">
                            ...
                            <button
                              ...
                              className={`transition-transform hover:scale-110 ${
                                i < reviewRating ? 'text-yellow-400 fill-yellow-400' : 'text-orange-200 fill-orange-200'
                              }`}
                            >
                          ...
                          <div className="flex items-center gap-3 flex-1">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-1">
                                {[...Array(5)].map((_, i) => (
                                  <svg key={i} className={`w-4 h-4 ${i < (review.rating || 0) ? 'text-yellow-400 fill-yellow-400' : 'text-orange-200 fill-orange-200'}`} viewBox="0 0 24 24">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                                  </svg>
                                ))}
                              </div>
                  ...
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, i) => (
                      <button
                        ...
                        onClick={() => setReviewRating(i + 1)}
                        className={`transition-transform hover:scale-110 ${
                          i < reviewRating ? 'text-yellow-400 fill-yellow-400' : 'text-orange-200 fill-orange-200 hover:text-yellow-300'
                        }`}
                      >
