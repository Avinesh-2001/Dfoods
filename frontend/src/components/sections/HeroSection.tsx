...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[600px] lg:h-[700px] overflow-hidden">
      ...
      <div className="relative h-full flex items-end justify-end p-8 lg:p-12 z-10">
        <motion.div
        ...
        >
          <Link
            href="/products"
            className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-900 font-bold text-lg rounded-full shadow-2xl hover:bg-gray-50 hover:scale-105 transition-all duration-300 backdrop-blur-sm border-2 border-white/50"
          >
            Shop Now
